...
public:
    ...
    CalibrationEngine* getCalibrationEngine() const { return m_calibrationEngine.get(); }
...
private:
    // 硬件层
    std::unique_ptr<SerialInterface> m_serialInterface;
    ...
    std::unique_ptr<CalibrationEngine> m_calibrationEngine;
